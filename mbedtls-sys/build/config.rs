...
pub const DEFAULT_DEFINES: &'static [CDefine] = &[
    ...
    ("MBEDTLS_REMOVE_ARC4_CIPHERSUITES",                  Undefined),
    ("MBEDTLS_REMOVE_3DES_CIPHERSUITES",                  Undefined),
